...
module Inquisition
  module Core
    module Presenters
      module Data
        module Common
          class FilesSummaryPresenter < Presenters::StaticPresenter
            STATS_DIRECTORIES = [
            ...
            def build_presenter
              @build_presenter ||= statistics.instance_variable_get(:@statistics).map(&method(:build_presenter_hash))
            end
            ...
            def statistics
              CodeStatistics.new(*directories)
            end
