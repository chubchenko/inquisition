RSpec.describe Inquisition::Outputter::Doc::TPL::Quality::Rubycritic do
  ...
  describe '.call' do
    ...
    let(:wrapper) { instance_double(Inquisition::Outputter::Doc::TPL::Quality::Rubycritic::Wrapper) }

    before do
      allow(Inquisition::Outputter::Doc::TPL::Quality::Rubycritic::Wrapper).to receive(:new).and_return(wrapper)
    ...
    it do
      expect(Inquisition::Outputter::Doc::TPL::Quality::Rubycritic::Wrapper).to have_received(:new).with(
        [issue]
      )
    end
  ...
  describe Inquisition::Outputter::Doc::TPL::Quality::Rubycritic::Wrapper do
