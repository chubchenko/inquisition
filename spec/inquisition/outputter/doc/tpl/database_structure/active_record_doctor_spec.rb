RSpec.describe Inquisition::Outputter::Doc::TPL::DatabaseStructure::ActiveRecordDoctor do
  ...
  describe '.call' do
    ...
    let(:wrapper) { instance_double(Inquisition::Outputter::Doc::TPL::DatabaseStructure::ActiveRecordDoctor::Wrapper) }
    ...
    it do
      expect(Inquisition::Outputter::Doc::TPL::DatabaseStructure::ActiveRecordDoctor::Wrapper).to have_received(:new)
        .with([issue])
    end
  ...
  describe Inquisition::Outputter::Doc::TPL::DatabaseStructure::ActiveRecordDoctor::Wrapper do
